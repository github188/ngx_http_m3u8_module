...
int GssLiveConnInterfaceGetVideoFrame(int glcIndex, unsigned char** pData, int *datalen);
void GssLiveConnInterfaceFreeVideoFrame(int glcIndex);

int GssLiveConnInterfaceGetAudioFrame(int glcIndex, unsigned char** pData, int *datalen);
